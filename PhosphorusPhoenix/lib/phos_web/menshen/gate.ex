defmodule PhosWeb.Menshen.Gate do
  ...
  the current_user:
      ...
      defmodule PhosWeb.PageLive do
        use PhosWeb, :live_view

        on_mount {PhosWeb.Menshen.Gate, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{PhosWeb.Menshen.Gate, :ensure_authenticated}] do
