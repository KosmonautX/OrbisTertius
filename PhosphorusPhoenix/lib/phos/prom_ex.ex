defmodule Phos.PromEx do
  ...
  3. Update your `endpoint.ex` file to expose your metrics (or configure a standalone
     ...
     ```
     defmodule PhosWeb.Endpoint do
       use Phoenix.Endpoint, otp_app: :phos
  ...
  def dashboards do
    [
      ...
      # {:phos, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
