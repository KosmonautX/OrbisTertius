defmodule Phos.Message.Memory do
  ...
  schema "memories" do
    ...
    belongs_to :mem_subject, Phos.Message.Memory, references: :id, type: Ecto.UUID
  ...
  def changeset(memory, attrs) do
    memory
    |> cast(attrs, [:id,:user_source_id, :orb_subject_id, :com_subject_id, :mem_subject_id, :rel_subject_id, :loc_subject_id, :message, :media])
  ...
  def gen_changeset(memory, attrs) do
    memory
    |> cast(attrs, [:id, :user_source_id, :orb_subject_id, :mem_subject_id, :rel_subject_id, :message, :media])
  ...
  def gen_reveries_changeset(memory, attrs) do
    memory
    |> cast(attrs, [:id, :user_source_id, :orb_subject_id, :mem_subject_id, :rel_subject_id, :media, :message])
