...
# Phos.Users.create_user(%{"username" => "Albert", "fyr_id" => "albert", "media" => false, "public_profile" => %{"birthday" => NaiveDateTime.utc_now(), "bio" => "Hi, i'm new to scratchbac!"}, "private_profile" => %{"geohash"=> [%{"id" => "home", "location_description" => "my home", "geohash" => "623276216933351423", "chronolock" => 1651765218}]}})
