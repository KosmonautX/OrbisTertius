...
# Phos.Users.create_user(%{"username" => "Albert", "fyr_id" => "albert", "media" => false, "profile" => %{"birthday" => NaiveDateTime.utc_now(), "bio" => user_payload["payload"]["bio"]}, "profile_pic" => user_payload["payload"]["profile_pic"] , "geohash"=> geo_map})
